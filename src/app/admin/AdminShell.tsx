...
const sidebarLinks = [
  ...
  },
  {
    ...
    label: "Devotionals",
    icon: BookOpen,
    perm: "devotionals:read",
  },
  {
    href: "/admin/testimonies",
    label: "Testimonies",
    icon: Heart,
    perm: "testimonies:read",
  },
  {
    href: "/admin/pubmats",
    label: "Pubmats",
...
function AdminUserChip() {
  ...
  return (
    <div className="flex items-center gap-3">
      {role && (
        <span
          className={`hidden rounded-full px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide sm:inline-block ${roleColors[role] || roleColors.viewer}`}
        >
          {role}
        </span>
      )}
