...
const mockTestimonies: Testimony[] = [
  {
    ...
    authorAge: 16,
    content: "God healed my mother during the prayer night...",
    imageUrl: null,
    approved: true,
  ...
  },
  {
    ...
    authorAge: 14,
    content: "I found true friendship in this fellowship...",
    imageUrl: null,
    approved: true,
  ...
  },
  {
    ...
    authorAge: 17,
    content: "The youth retreat changed my perspective on faith...",
    imageUrl: null,
    approved: false,
  ...
  },
  {
    ...
    authorAge: 15,
    content: "I learned to trust God even in difficult times...",
    imageUrl: null,
    approved: false,
