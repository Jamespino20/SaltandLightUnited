  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-[#0A0A0A]">
        <div
          className="absolute left-1/2 top-0 -z-10 h-72 w-72 -translate-x-1/2 rounded-full bg-slu-blue/40 blur-3xl"
          aria-hidden
        />
        <div className="mx-auto max-w-7xl px-4 py-24 text-center sm:px-6 sm:py-32 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/70">
            A growing space for SLU devotionals and stories of what God is doing
            in our lives.
          </p>
        </div>
      </section>
            ...
            <div>
              <h2 className="text-2xl font-bold text-slu-black">
                {activeTab === "Devotionals"
                  ? "Devotionals from the community"
              ...
              {loading ? (
                <p className="mt-8 text-sm text-slu-gray-500">
                  Loading submissions...
                </p>
              ) : entries.length === 0 ? (
                <div className="mt-8 rounded-2xl border border-dashed border-slu-gray-300 bg-white p-8">
                  ...
                  <p className="mt-2 text-sm text-slu-gray-500">
                    Be the first person to contribute below.
                  </p>
                </div>
              ) : (
                  ...
                  {activeTab === "Devotionals"
                    ? devotionals.map((item) => (
                        ...
                        >
                          ...
                          <h3 className="mt-2 text-xl font-bold text-slu-black">
                            {item.title}
                          </h3>
                          <p className="mt-3 whitespace-pre-line text-sm leading-relaxed text-slu-gray-600">
                            {item.content}
                          </p>
                          {item.author && (
                            <p className="mt-4 text-xs font-semibold text-slu-gray-500">
                              By {item.author}
                            </p>
                          )}
                        </article>
                    ...
                    : testimonies.map((item) => (
                        <article
                          ...
                          className="rounded-2xl border border-slu-gray-200 bg-white p-6"
                        >
                          <p className="text-sm leading-relaxed text-slu-gray-600">
                            {item.content}
                          </p>
                          <p className="mt-4 text-xs font-semibold text-slu-gray-500">
            ...
            <div className="h-fit rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slu-gray-200">
              ...
              {activeTab === "Devotionals" ? (
                <form onSubmit={submitDevotional} className="mt-6 space-y-4">
                  <label className="block text-sm font-semibold text-slu-black">
                    Title
                    <input
                      required
                      ...
                      className="mt-1.5 w-full rounded-xl border border-slu-gray-200 px-3 py-2.5 font-normal focus:border-slu-blue focus:outline-none focus:ring-2 focus:ring-slu-blue/20"
                    />
                  </label>
                  <label className="block text-sm font-semibold text-slu-black">
                    Your name{" "}
                    <span className="font-normal text-slu-gray-400"></span>
                    <input
                      required
                  ...
                  <label className="block text-sm font-semibold text-slu-black">
                    ...
                    <textarea
                      ...
                      className="mt-1.5 w-full resize-y rounded-xl border border-slu-gray-200 px-3 py-2.5 font-normal focus:border-slu-blue focus:outline-none focus:ring-2 focus:ring-slu-blue/20"
                    />
                  </label>
                  <button
                    disabled={submitting}
              ...
              {notice && (
                <p className="mt-4 text-sm font-medium text-slu-blue">
                  {notice}
                </p>
              )}
            </div>
