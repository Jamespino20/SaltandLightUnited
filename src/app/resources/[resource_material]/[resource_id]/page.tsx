        ...
        {resourceType === "devotionals" && (() => {
          ...
          return (
            <>
              ...
              <div className="resource-content text-slu-gray-700" data-lenis-prevent dangerouslySetInnerHTML={{ __html: dev.content }} />
            </>
          );
        })()}
        ...
        {resourceType === "testimonies" && (() => {
          ...
          return (
            <>
              ...
              <div className="resource-content text-slu-gray-700" data-lenis-prevent dangerouslySetInnerHTML={{ __html: ts.content }} />
            </>
          );
        })()}
