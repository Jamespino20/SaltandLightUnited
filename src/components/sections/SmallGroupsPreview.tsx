...
const slides = [
  { id: "1", label: "Teens for Christ", caption: "Ages 13–17 · Growing in faith together", image: "/images/history/first_pic.webp" },
  { id: "2", label: "Tweens of Light", caption: "Ages 10–12 · Building a strong foundation", image: "/images/history/second_pic.jpg" },
  { id: "3", label: "Worship Team", caption: "Leading praise through music and song", image: "/images/history/third_pic.webp" },
  { id: "4", label: "Bible Study", caption: "Diving deep into God's Word together", image: "/images/history/fourth_pic.webp" },
  { id: "5", label: "Outreach Ministry", caption: "Serving the community with Christ's love", image: "/images/history/fifth_pic.jpg" },
];
...
export function SmallGroupsPreview() {
  ...
  return (
    <section id="groups" className="relative overflow-hidden bg-[#F0F0F0] py-16 sm:py-24">
      {/* Decorative waves */}
      <div className="absolute bottom-0 left-0 right-0 -z-10" aria-hidden>
        <svg viewBox="0 0 1440 120" preserveAspectRatio="none" className="block h-16 w-full sm:h-24">
          <path d="M0,80 C180,120 360,40 540,80 C720,120 900,40 1080,80 C1260,120 1440,60 1440,80 L1440,120 L0,120 Z" fill="#0770BD" opacity="0.25" />
          <path d="M0,90 C240,50 480,110 720,70 C960,30 1200,90 1440,60 L1440,120 L0,120 Z" fill="#0770BD" opacity="0.15" />
        </svg>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal className="mb-10 text-center">
          <h2 className="text-3xl font-bold text-slu-black sm:text-4xl lg:text-5xl">
            Want to see us wave?{" "}
            <span className="text-slu-blue">Here&apos;s the Salters for you.</span>
          </h2>
        </Reveal>
