        ...
        <div className="grid items-center gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <Reveal>
            ...
            <p className="mt-4 text-base text-white/80 sm:mt-6 sm:text-lg">
              Stay updated with our latest events, photos, and community
              stories. Follow our page and join the conversation.
            </p>
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs font-medium text-white group-hover:underline sm:text-sm">
                    Follow us &rarr;
                  </p>
                </div>
              </a>
